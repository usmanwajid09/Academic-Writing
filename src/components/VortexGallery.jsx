...
const ITEMS = [
  { title: 'Academic Essay', icon: '📝', rate: 'From $8.00/page', description: 'Argumentative, narrative, and analysis essays custom structured.' },
  { title: 'Research Paper', icon: '🔍', rate: 'From $8.00/page', description: 'Deep qualitative or quantitative investigations with references.' },
  { title: 'Case Study', icon: '📊', rate: 'From $8.00/page', description: 'Corporate breakdowns and SWOT strategizing reports.' },
  { title: 'Dissertation', icon: '🎓', rate: 'From $8.00/page', description: 'Advanced chapters, outlines, and proposals written by PhDs.' },
  { title: 'Coursework', icon: '📚', rate: 'From $8.00/page', description: 'Weekly assignments, reviews, and short problem solutions.' },
  { title: 'Admission Essay', icon: '🚀', rate: 'From $8.00/page', description: 'High-impact personal statements to lock university spots.' },
  { title: 'Term Paper', icon: '📁', rate: 'From $8.00/page', description: 'Semester-end research papers summarizing subject literature.' },
  { title: 'Book Report', icon: '📖', rate: 'From $8.00/page', description: 'Detailed breakdowns, thematic analyzes, and character studies.' }
];
